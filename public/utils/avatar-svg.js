    ...
    return `
        <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style="width: ${size}; height: ${size}; max-width: 100%; max-height: 100%; display:block;">
            ...
            <g clip-path="url(#avatarClip)">
                <circle cx="50" cy="42" r="30" fill="${base}"/>
                <path d="M50 68
                         C42 68 35 69 29 71
                         C19 74.5 12 81 8 94
                         L8 105
                         L92 105
                         L92 94
                         C88 81 81 74.5 71 71
                         C65 69 58 68 50 68 Z"
                      fill="${base}"/>
                <path d="M50 69
                         C44 69 38.5 69.8 33.3 71
                         C38.2 73 44 74 50 74
                         C56 74 61.8 73 66.7 71
                         C61.5 69.8 56 69 50 69 Z"
                      fill="${shade}"
                      opacity="0.14"/>
            </g>
