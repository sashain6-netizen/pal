    ...
    return `
        <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style="width: ${size}; height: ${size}; max-width: 100%; max-height: 100%; display:block;">
            ...
            <g clip-path="url(#avatarClip)">
                <circle cx="50" cy="57" r="30" fill="${base}"/>
                <path d="M50 83
                         C42 83 35 84 29 86
                         C19 89.5 12 96 8 109
                         L8 105
                         L92 105
                         L92 109
                         C88 96 81 89.5 71 86
                         C65 84 58 83 50 83 Z"
                      fill="${base}"/>
                <path d="M50 84
                         C44 84 38.5 84.8 33.3 86
                         C38.2 88 44 89 50 89
                         C56 89 61.8 88 66.7 86
                         C61.5 84.8 56 84 50 84 Z"
                      fill="${shade}"
                      opacity="0.14"/>
            </g>
